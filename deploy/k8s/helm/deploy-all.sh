...
if [[ $push_images ]]; then
  ...
  services=(basket.api catalog.api identity.api ordering.api payment.api webmvc webspa webblazor webstatus)
...
charts=(eshop-common basket-api catalog-api identity-api mobileshoppingagg ordering-api ordering-backgroundtasks ordering-signalrhub payment-api webmvc webshoppingagg webspa webblazor webstatus webhooks-api webhooks-web)
